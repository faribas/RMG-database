...
""",
    history = [
        ("TThu March 19 13:51:43 2014","Fariba Seyedzadeh khanshan <seyedzadehkhanshan.f@husky.neu.edu>","action","""Fariba Seyedzadeh Khanshan <seyedzadehkhanshan.f@husky.neu.edu> created this entry."""),
    ],
)
